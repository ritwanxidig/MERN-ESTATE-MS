    ...
    <div className='flex w-full flex-col p-4 max-w-7xl mx-auto'>
      ...
      <div className='flex flex-col md:flex-row justify-between items-start gap-5'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <button type='submit' onClick={handleSubmit} disabled={uploadingState} className="button-design bg-green-500 hover:bg-green-600 transition-all duration-700 font-semibold text-white">Submit</button>
        </div>
      </div>
    </div>
